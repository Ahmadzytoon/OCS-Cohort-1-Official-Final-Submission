    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="discount_value" name="discount_value" step="0.01" value="{{ old('discount_value') }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" step="0.01" value="{{ old('min_order_amount') }}">
