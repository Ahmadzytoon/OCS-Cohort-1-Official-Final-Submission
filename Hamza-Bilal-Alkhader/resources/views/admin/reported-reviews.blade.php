  ...
  <div class="container-fluid container-xl" data-aos="fade-up">
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-9">
        <div class="mb-3">
          <h3 class="mb-1">Reported Reviews</h3>
          <div class="text-muted small">Only reviews that have at least one report</div>
        </div>
        ...
        <div class="card shadow-sm border-0">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <div class="fw-semibold">Reported Reviews</div>
            ...
            <div class="text-muted small mt-2">
              This page shows only reviews that have at least one report.
            </div>
          </div>
        </div>
